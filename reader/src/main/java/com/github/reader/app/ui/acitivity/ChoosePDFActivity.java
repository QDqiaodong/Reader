package com.github.reader.app.ui.acitivity;
...
import com.github.reader.app.model.entity.ChoosePDFItem;
import com.github.reader.app.ui.adapater.ChoosePDFAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mUpdateFiles = new Runnable() {
			public void run() {
				...
				if(mDirectory.getAbsolutePath().endsWith("0")){
					mParent = null;
					Log.d("qd","已到达根目录");
				}
